...
def get_args():
    ...
    parser.add_argument('--attack_type', default='PGD', type=str, choices=['PGD', 'FGSM','APGD'])
    ...
    parser.add_argument('--thershold', default=0.20, type=float)
...
def eval_corruptions(model):
    ...
    for ci, cname in enumerate(corruptions):
            ...
            # load dataset
            dataset = CIFAR100C(
                    os.path.join(data_root, 'CIFAR-100-C'),
